...
import com.demo.collectionandmap.collection.list.model.Apple;
import com.demo.collectionandmap.collection.list.model.Fruit;
import com.demo.collectionandmap.collection.list.model.Grape;
import com.demo.collectionandmap.collection.list.model.Orange;
...
public class ArraylistDemo {
    ...
    public void test1() {
        ...
        System.out.println(container);//Collection集合重写了toString方法
    }
    ...
    public void test4() {
        ...
        System.out.println("c.contains('@'):" + container.contains('@'));
