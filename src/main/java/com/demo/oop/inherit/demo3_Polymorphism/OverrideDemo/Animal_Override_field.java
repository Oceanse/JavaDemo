 ...
 */
public class Animal_Override_field {
    String id="37xxx";//身份证号

    public Animal_Override_field() {
    }

    public Animal_Override_field(String id) {
        this.id = id;
    }
...
class Stu extends Animal_Override_field{
    String id="15xx";//学号
    ...
    public static void main(String[] args) {
        ...
        Animal_Override_field s2=new Stu();
