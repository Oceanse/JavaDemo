...
class BlockTest4{
    public static void main(String[] args) {
        //构造代码块和属性初始值执行的顺序取决两者在代码中的先后顺序，谁在前，谁先执行
        System.out.println(new Person4().name);
        System.out.println(new Person4().age);

        //初始化顺序：属性初始值/代码块(取决于两者代码先后顺序)-->构造器
        System.out.println(new Person4("haiyang", 31).name);
        System.out.println(new Person4("haiyang", 31).age);
    }
}