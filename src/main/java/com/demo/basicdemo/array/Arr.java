...
public class Arr {
    ...
    public void test(){
        ...
        TestResourceinfo[] t=new TestResourceinfo[3];//声明同时分配内存空间
        for (int i = 0; i < t.length; i++) {
            t[i]=new TestResourceinfo();
        }
        ...
        *//*====================================================================================================
        ...
        TestResourceinfo[] tt2=new TestResourceinfo[]{new TestResourceinfo(),new TestResourceinfo(),new TestResourceinfo()};
